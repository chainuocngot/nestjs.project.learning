...
import { HTTPMethod, REQUEST_ROLE_PERMISSIONS, REQUEST_USER_KEY } from 'src/shared/constants/auth.constant';
...
export class AccessTokenGuard implements CanActivate {
  ...
  private async validateUserPermission(decodedAccessToken: AccessTokenPayload, request: any): Promise<void> {
    ...
    const method = request.method as (typeof HTTPMethod)[keyof typeof HTTPMethod];
